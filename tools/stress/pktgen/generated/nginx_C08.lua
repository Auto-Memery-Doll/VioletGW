...
pktgen.range.src_port(port, "start", 50000)
pktgen.range.src_port(port, "inc", 1)
pktgen.range.src_port(port, "min", 50000)
pktgen.range.src_port(port, "max", 50999)
...
print(string.format(
  "PKTGEN_SUMMARY sut=nginx case=C08 mode=newflow payload=4096 " ..
