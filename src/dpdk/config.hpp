...
const unsigned DPDK_mempool_block_size = RTE_MBUF_DEFAULT_BUF_SIZE;
const uint16_t DPDK_mempool_block_num = 8192;
...
const uint16_t DPDK_nb_rx_queue_desc = 512;
const uint16_t DPDK_nb_tx_queue_desc = 512;
...
const uint32_t DPDK_max_frame_size = RTE_ETHER_MAX_LEN;
